...
public static class ChatSystemPrompt
{
    public const string Text =
        ...
        "Khi người dùng yêu cầu tạo mặt cắt dọc dầm hàng loạt, gọi draw_beam_longitudinal_drawing với beamsPerSheet do người dùng chọn và sheetNumbers là các sheet có sẵn còn trống theo đúng thứ tự phân bổ. Không dùng open_beam_drawing hoặc draw_beam_drawing cho yêu cầu này. " +

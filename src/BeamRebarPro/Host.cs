using BeamRebarPro.Configuration;
...
public static class Host
{
    ...
    public static T GetService<T>() where T : class
    {
        ...
        if (typeof(T) == typeof(BeamRebarProViewModel))
            return (T)(object)new BeamRebarProViewModel(GetService<ILogger>());

        if (typeof(T) == typeof(BeamRebarProView))
            return (T)(object)new BeamRebarProView(GetService<BeamRebarProViewModel>());

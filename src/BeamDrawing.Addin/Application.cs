...
public class Application : ExternalApplication
{
    ...
    {
        var panel = Application.CreatePanel("BIM Tools", "BeamDrawing");

        panel.AddPushButton<Commands.BeamDrawingCommand>("Beam Drawing")
            .SetImage("/BeamDrawing.Addin;component/Resources/Icons/RibbonIcon16.png")
            .SetLargeImage("/BeamDrawing.Addin;component/Resources/Icons/RibbonIcon32.png");
    }
}
